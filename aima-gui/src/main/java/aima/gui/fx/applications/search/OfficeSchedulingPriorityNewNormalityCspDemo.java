...
import aima.core.search.csp.examples.OfficeSchedulingPriorityNewNormalityCSP;
...
public class OfficeSchedulingPriorityNewNormalityCspDemo {

	public static void main(String[] args) {
		CSP<Variable, List<Integer>> csp = new OfficeSchedulingPriorityNewNormalityCSP();
		...
		csp = new OfficeSchedulingPriorityNewNormalityCSP();
