...
import aima.core.search.csp.examples.OfficeSchedulingPriorityWorkingCSP;
...
public class OfficeSchedulingPriorityWorkingCspDemo {

	public static void main(String[] args) {
		CSP<Variable, List<Integer>> csp = new OfficeSchedulingPriorityWorkingCSP();
		...
		System.out.println("The Office scheduling problem | Priority Working - (Min-Conflicts)");
		...
		System.out.println("The Office scheduling problem | Priority Working - (Backtracking + MRV & DEG + LCV + AC3)");
		csp = new OfficeSchedulingPriorityWorkingCSP();
		...
		System.out.println("The Office scheduling problem | Priority Working - (Backtracking)");
		csp = new OfficeSchedulingPriorityWorkingCSP();
